      ...
      <nav className={`fixed top-[2px] left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-white shadow-md" : "bg-white/95"}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-[72px]">
            ...
            <div className="hidden md:flex items-center gap-5">
              ...
              <a href="tel:5597976081" className="inline-flex items-center gap-2 bg-orange text-white px-5 py-2.5 rounded-lg font-semibold text-sm hover:bg-orange-dark transition-colors cta-press">
        ...
        <div className={`md:hidden fixed inset-0 top-[74px] bg-white z-40 overflow-y-auto transform transition-transform duration-300 ${mobileOpen ? "translate-x-0" : "translate-x-full"}`}>
          <div className="flex flex-col p-6 gap-2">
            ...
            <a href="tel:5597976081" className="mt-4 flex items-center justify-center gap-2 bg-orange text-white px-6 py-4 rounded-xl font-bold text-lg cta-press" onClick={() => setMobileOpen(false)}>
